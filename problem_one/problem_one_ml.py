...
print('The score For Knn:' , f1_score(y_test , y_pred))
...
print('The score For SVM: ' , f1_score(y_test , y_pred))
...
classifier.fit(x_train,y_train)
y_pred = classifier.predict(x_test)
print('The score For Logistic Regression: ' , f1_score(y_test , y_pred))
...
classifier.fit(x_train,y_train)
y_pred = classifier.predict(x_test)
print('The score For Naive Bayes: ' , f1_score(y_test , y_pred))
...
classifier.fit(x_train,y_train)
y_pred = classifier.predict(x_test)
print('The score For Decision Trees: ' , f1_score(y_test , y_pred))
...
classifier.fit(x_train,y_train)
y_pred = classifier.predict(x_test)
print('The score For Random Forest: ' , f1_score(y_test , y_pred))
